...
* `event_casting` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `EVENT CASTING` - executable or bundle name on disk.
* `EVENT CASTING` - display name shown in window titles and about app dialogs.
